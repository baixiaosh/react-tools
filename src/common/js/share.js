(function() {
    var wxapi = '//res.wx.qq.com/open/js/jweixin-1.4.0.js',
    ...
    function _initWX(data) {
        ...
        require([wxapi], function(wx) {
            ...
            wx.config({
                ...
                jsApiList: ['hideMenuItems', 'onMenuShareTimeline', 'onMenuShareAppMessage', 'onMenuShareQQ', 'onMenuShareQZone', 'chooseWXPay']
            });
    ...
    function _initQQ(data) {
        console.log('配置===initQQ===');
        var info = { title: data.title, desc: data.summary, share_url: data.url, image_url: data.pic };
        function doQQShare() {
            try {
                if (data.callback) {
                    window.mqq.ui.setOnShareHandler(function(type) {
                        if (parseInt(type, 10) === 3 && (data.swapTitle || (data.WXconfig && data.WXconfig.swapTitleInWX))) {
    ...
    function _initQZ(data) {
        ...
        function doQZShare() {
            if (window.QZAppExternal && window.QZAppExternal.setShare) {
                ...
                window.QZAppExternal.setShare(function(data) {}, { type: 'share', image: imageArr, title: titleArr, summary: summaryArr, shareURL: shareURLArr });
            }
        }
